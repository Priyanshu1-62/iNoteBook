  ...
  return (
    <div className="flex flex-col justify-center items-center w-lvw h-lvh">
      <form onSubmit={handleSubmit} className="relative h-fit w-fit border-r-3 border-b-3 border-stone-600 rounded-xl caret-pink-800 selection:bg-pink-600 backdrop-blur-[64px]">
        ...
        <button type="submit" disabled={loadingAuth} className={`backdrop-blur-[300px] text-xs w-60 mb-5 mx-5 px-[0.5rem] py-[0.18rem] font-bold border-1 border-stone-500 drop-shadow-xl ${loadingAuth?"opacity-70 cursor-not-allowed":"cursor-pointer hover:bg-stone-400 active:bg-stone-500"}`}>Signup</button>
