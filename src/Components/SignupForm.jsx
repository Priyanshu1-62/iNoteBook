  ...
  return (
    <div className="flex justify-center">
      <form onSubmit={handleSubmit} className="absolute top-[20vh] border-r-3 border-b-3 border-stone-600 rounded-xl backdrop-blur-[64px]">
        ...
        <button type="submit" className="backdrop-blur-[300px] text-xs w-60 mb-5 mx-5 px-[0.5rem] py-[0.18rem] font-bold border-1 border-stone-500 hover:bg-stone-400 active:bg-stone-500 drop-shadow-xl">Signup</button>
