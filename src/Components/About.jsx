        ...
        <div>
          ...
          <div className="flex gap-2 mb-2">
            ...
            <div>
              ...
              <a className="flex my-1 w-fit text-blue-700 dark:text-blue-300 hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/Priyanshu1-62/iNoteBook.git">
                <p>Frontend</p>
                <ExternalLink className="w-3 h-3"/>
              </a>
              <a className="flex mt-2 w-fit text-blue-700 dark:text-blue-300 hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/Priyanshu1-62/iNoteBook-Server.git">
                <p>Backend</p>
                <ExternalLink className="w-3 h-3"/>
              </a>
            </div>
          ...
          <div className="flex gap-2 mb-2">
            ...
            <div className="flex flex-wrap w-fit">
              <p className="">To report a bug or share suggestions, feel free to email me at : &nbsp;</p>
